...
def index
  ...
  render :json => {
    ...
    clients_with_application: clients_with_application(" WHERE #{clause}"),
    clients_missing_data: clients_missing_data(" AND #{clause}"),
    average_credit_score: average_credit_score(" WHERE #{clause}")
  }
end
